...
const WHATSAPP_NUMBER = '16318484432';

const WhatsAppButton: React.FC = () => {
  const [showTooltip, setShowTooltip] = useState(false);

  const openWhatsApp = () => {
    const message = encodeURIComponent("Hi! I'm interested in renting a dumpster from Superior Waste. Can you help me get a quote?");
      ...
      {showTooltip && (
        <div className="bg-white rounded-lg shadow-xl p-4 max-w-xs">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Have questions? Chat with our team on WhatsApp for instant support!
          </p>
          <button
